...
//energy testing
	...
	std::cout << "#################################################" << std::endl;
	std::cout << "Testing SupaTrap Member functions" << std::endl;
	std::cout << "#################################################" << std::endl;
	SuperTrap supa("supaTrap");
	supa.ninjaShoebox(Clap);
	supa.ninjaShoebox(FR4GTP);
	supa.ninjaShoebox(Scav);
	supa.ninjaShoebox(ninja2);
	supa.rangedAttack("Badass!");
	supa.meleeAttack("Badass!");
	std::cout << "#################################################" << std::endl;
	std::cout << "Testing SupaTrap energy points" << std::endl;
	std::cout << "#################################################" << std::endl;
	std::cout << supa.geteP() << std::endl;
	supa.vaulthunter_dot_exe("Badass!");
	std::cout << supa.geteP() << std::endl;
	supa.vaulthunter_dot_exe("Badass!");
	std::cout << supa.geteP() << std::endl;
	supa.vaulthunter_dot_exe("Badass!");
	...
	supa.vaulthunter_dot_exe("Badass!");
	std::cout << "#################################################" << std::endl;
	std::cout << "Testing supaTrap varibles" << std::endl;
	std::cout << "#################################################" << std::endl;

	std::cout << "curent hp "<< supa.gethp() << std::endl;
	std::cout << "maxhp "<< supa.getmaxHp() << std::endl;
	std::cout << "curent ep "<< supa.geteP() << std::endl;
	std::cout << "curent maxep "<< supa.getmaxEp() << std::endl;
	std::cout << "curent levle "<< supa.getlevle() << std::endl;
	std::cout << "melee damage "<< supa.getmeleeDamage() << std::endl;
	std::cout << "ranaged damage "<< supa.getrangeAttackDamage() << std::endl;
	std::cout << "armour "<< supa.getarmour() << std::endl;
	std::cout << "name "<< supa.getname() << std::endl;
//testing membre functions
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing supaTrap Attacks" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	supa.rangedAttack("Badass!");
	supa.meleeAttack("Badass!");
//energy testing
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing supaTrap hitpoints" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << supa.gethp() << std::endl;
	supa.beRepaired(100);
	std::cout << supa.gethp() << std::endl;
	supa.beRepaired(0);
	std::cout << supa.gethp() << std::endl;
