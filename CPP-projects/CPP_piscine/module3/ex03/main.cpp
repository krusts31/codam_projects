...
//testing hp
	...
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing ninjaShoebox" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	NinjaTrap ninja("Katana");
	NinjaTrap ninja2("Nunchuks");
	ninja.ninjaShoebox(Clap);
	ninja.ninjaShoebox(FR4GTP);
	ninja.ninjaShoebox(Scav);
	ninja.ninjaShoebox(ninja2);
	ninja.rangedAttack("Badass!");
	ninja.meleeAttack("Badass!");
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing ninjaTrap varibles" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "curent hp "<< ninja.gethp() << std::endl;
	std::cout << "maxhp "<< ninja.getmaxHp() << std::endl;
	std::cout << "curent ep "<< ninja.geteP() << std::endl;
	std::cout << "curent maxep "<< ninja.getmaxEp() << std::endl;
	std::cout << "curent levle "<< ninja.getlevle() << std::endl;
	std::cout << "melee damage "<< ninja.getmeleeDamage() << std::endl;
	std::cout << "ranaged damage "<< ninja.getrangeAttackDamage() << std::endl;
	std::cout << "armour "<< ninja.getarmour() << std::endl;
	std::cout << "name "<< ninja.getname() << std::endl;
//testing membre functions
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing ninjaTrap Attacks" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	ninja.rangedAttack("Badass!");
	ninja.meleeAttack("Badass!");
//energy testing
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << "Testing ninjaTrap Hitpoints" << std::endl;
	std::cout << "oooooooooooooooooooooooooooooooooooooooooooooooooo" << std::endl;
	std::cout << ninja.gethp() << std::endl;
